...
class PermissionsController extends AdminController
{
    ...
    public function __construct(PermissionsRepository $per_rep, RolesRepository $rol_rep)
    {
        ...
        $this->template = env('THEME').'.admin.permissions.permissions';
    }
    ...
    {   
        ...
        $this->content = view(env('THEME').'.admin.permissions.permissions_content')->with(['roles'=>$roles,'permissions'=>$permissions]);
