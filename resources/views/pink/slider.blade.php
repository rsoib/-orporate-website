	...
	<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
		<ul class="slider">
			...
			@foreach($sliders as $slider)
				...
				<li>
					<div class="slide-holder" style="background:  url('{{ asset('assets') }}/images/{{ $slider->sl_img }}') no-repeat center center" style="height:483px;">
							...
							@if($i%2 !== 0)
								...
								@endif
										<div class="slide-title">
				                        	<h2 style="color:#fff">{!! $slider->sl_title !!}</h2>
				                    	</div>
			...
			@endforeach
				    ...
				    <div id="yit-widget-area" class="group">
				        <div class="yit-widget-content inner group">
				            <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
				                <img class="icon-img" src="{{ asset('assets') }}/images/icons/cloud.jpg" alt="" />		
				                <h3>Great Design</h3>
				...
				<div class="mobile-slider">
				    <div class="slider fixed-image inner"><img src="{{ asset('assets') }}/images/slider-cycle/cycle-fixed.jpg" alt="" /></div>
				</div>
