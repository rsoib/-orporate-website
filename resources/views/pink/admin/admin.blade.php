...
<![endif]-->
    ...
    <!-- END HEAD -->
     ...
     <body class="no_js responsive {{ (Route::currentRouteName() == 'adminIndex') || (Route::currentRouteName() == 'portfolios.index') || (Route::currentRouteName() == 'portfolios.show') ? 'page-template-home-php' : '' }} stretched">
